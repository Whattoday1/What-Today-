...
<header class="navbar navbar-expand-lg navbar-light fixed-top custom-navbar">
    ...
    <!-- 폼 영역 -->
    <!-- 로그인 폼 -->
    <form id="register_form" action="/login.do" method="post" name="frm">
        <ul>
            <li>
                <br>
                <h3>로그인</h3>
            ...
            <li>
                <label for="user_id" style="margin-right: 250px; color: #666565;">
                	<b>아이디</b>
                </label><br>
                <input class="userid" name="user_id" type="text" required autofocus value="${user_id}" }>
            </li>
            <li>
                <label for="user_pw" style="margin-right: 230px; color: #666565;">
                	<b>비밀번호</b>
                </label><br>
                <input class="pwd" name="user_pw" type="password" required>
            </li>
            
            

	        <li style="height:30px; font-size:15px;">
            ...
            <li>
                ...
                <br>
                <button type="submit" style="color:white" onclick="return loginCheck()">로그인</button>
            </li>
        </ul>
	</form>
    
<hr>
  <p class="find"  style=" text-align: center;">
      <span><a href="" style=color:#666565; >아이디 찾기 </a></span>
      <span> | </span>
      <span><a href=""style=color:#666565; >비밀번호 찾기 </a></span>
      <span> | </span>
      <span><a href="join.do"style=color:#666565; onclick="location.href='/join.do'">회원가입</a></span>
  </p>
      </div>
