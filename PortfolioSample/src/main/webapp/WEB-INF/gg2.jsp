...
<body>
  ...
  <!-- 개인정보보호 -->
  <div id="contents">
    <legend class="tit" style="color:#3c3c3c;">개인정보처리방침</legend>
    <hr>
    <div class="terms-content">
      <div class="terms_bx clearfix agreeType1">
        <ul class="pull-left" id="titleLeft">
          <li><strong>제1조.</strong> 개인정보의 처리목적</li>
          <li><strong>제2조.</strong> 개인정보의 처리 및 보유 기간</li>
          <li><strong>제3조.</strong> 개인정보의 제 3자 제공</li>
          <li><strong>제4조.</strong> 개인정보 처리의 위탁</li>
          <li><strong>제5조.</strong> 정보주체의 권리, 의무 및 행사 방법</li>
          <li><strong>제6조.</strong> 개인정보의 파기 절차 및 방법</li>
          <li><strong>제7조.</strong> 개인정보의 안전성 확보조치</li>
          <li><strong>제8조.</strong> 개인정보 자동 수집 장치의 설치 · 운영 및 거부에 관한 사항</li>
          <li><strong>제9조.</strong>  개인정보 보호책임자</li>
          <li><strong>제10조.</strong> 개인정보 열람청구</li>
          <li><strong>제11조.</strong> 권익침해 구제방법</li>
          <li><strong>제12조.</strong> 영상정보처리기기 설치</li>
          <li><strong>제13조.</strong> 개인위치정보의 처리</li>
          <li><strong>제14조.</strong> 개인정보 처리방침 변경</li>
          <li>&nbsp;</li>
        </ul>
      </div>
      <hr>
        ...
        <iframe id="terms" src="./DB/PrivacyPolicy.html" title="내용" style="margin: 10px;"></iframe>
    </div> 
  </div>
