...
<header class="navbar navbar-expand-lg navbar-light fixed-top custom-navbar">
    ...
    <div class="form-container1">
      <h4 style="color: #3c3c3c;"><b>Login</b></h4>
		...
		<table>
			...
			<tr>
				...
				<td colspan="2" align="center"><input type="submit" value="로그인"
					onclick="return loginCheck()" style="background-color:#b30909; color: white; border: none; border-radius: 5px; width: 60px; height: 40px;">
			</tr>
			<tr>
				<td colspan="2"></td>
			</tr>
...
<br>
<br>
  <p class="find"  style=" text-align: center; margin-bottom:0px;">
      <span><a href="" style=color:#666565; >아이디 찾기 </a></span>
      <span> | </span>
      <span><a href=""style=color:#666565; >비밀번호 찾기 </a></span>
      <span> | </span>
      <span><a style=color:#666565; href="join.do">회원가입</a></span>
  </p><!-- onclick="location.href='/join.do'" -->
      <br>
  <br>
  <br>
      </div>
