...
<div class="post-container">
    <h1 class="post-title">[LGU+멤버십] 시스템 점검일정 변경 안내 (9/24~9/25)</h1>
    <p class="post-info">작성자: 관리자 | 작성일: 2023.10.12</p>
    <p class="post-content">
      안녕하세요.기존 9월 17일부터 18일까지로 예정되었던 LGU+멤버십 시스템 점검 작업의 일정이 변경되었습니다.<br>
      변경된 일정은 9월 24일부터 25일까지이며, 점검 작업이 진행되는 동안 LGU+멤버십 사용이 어려운 부분에 대해<br>
      양해 부탁드리겠습니다.<br>
      <시스템 점검 시간 및 내용><br>
      1. 작업 일시 : 2023년 9월 24일(일) 06:00 ~ 9월 25일(월) 10:00 (28시간)<br>
      2. 작업 내용<br>
      - 멤버십 시스템 점검<br>
      3. 작업 영향<br>
      - U+ 멤버십앱 바코드 사용 불가 (멤버십, 나만의콕 등 서비스 사용 불가)<br>
      이용에 불편을 드린 점 양해부탁드리며,<br>
      빠르게 조치하여 정상적인  서비스를 제공 할수 있도록 노력하겠습니다. <br>
      감사합니다.</p>
    </div>
    <div class="comment-input">
      <a href="sub.do?action=gg"><button class="comment-button">목록</button></a>
  </div>
</div>
</div>
