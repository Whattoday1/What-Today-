 ...
 */
@WebServlet("/postController3")
public class PostController3 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action == null) {
			getServletContext().getRequestDispatcher("/postController3?action=list").forward(request, response);
		} else {
			switch(action) {
